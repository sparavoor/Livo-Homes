...
export default async function Home() {
  ...
  return (
    <main className="pt-24 bg-background">
      ...
      <section className="py-48 px-10 max-w-[1440px] mx-auto border-t border-outline/5">
        <MotionSection className="text-center mb-32">
          ...
          <h2 className="font-headline text-5xl md:text-6xl font-black text-primary tracking-tight leading-tight">
            Crafting the <span className="font-serif italic text-secondary/50">Extraordinary.</span>
          </h2>
        </MotionSection>
