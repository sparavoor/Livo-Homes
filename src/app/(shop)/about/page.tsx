    ...
    <div className="container mx-auto px-8 py-24 pt-32 max-w-4xl">
      ...
      <div className="bg-surface-container-lowest rounded-2xl p-10 border border-outline-variant/30 shadow-sm mb-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-secondary text-lg leading-relaxed flex flex-col gap-6">
          <p>For over 12 years, LIVO has been a trusted name in quality, innovation, and modern home solutions. From its humble beginning in Malappuram, Kerala, LIVO has grown into a recognized brand serving customers across India and international markets.
            <br></br>
            At LIVO, we believe every home deserves products that combine functionality, durability, elegance, and affordability. Our commitment is to deliver premium-quality solutions that enhance comfort, style, and everyday living.
            <br></br>
            Today, LIVO offers a complete range of home solution products including Sanitaryware, Electrical Products, CP Fittings, Kitchen Sinks, Plumbing Materials, and Bathroom Accessories, designed to meet the needs of modern homes and commercial spaces.
            <br></br>
            With a strong focus on quality, customer satisfaction, and contemporary design, LIVO continues to redefine modern living experiences.</p>
          <p></p>
        </div>
      </div>
