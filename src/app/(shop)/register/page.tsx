    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface">
        <div className="w-full max-w-md p-10 flex flex-col items-center">
            ...
            <p className="text-[10px] uppercase font-black tracking-[0.3em] text-secondary/40 animate-pulse">Initializing Identity...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-8 py-24 pt-32 flex justify-center items-center min-h-[80vh]">
      <div className="w-full max-w-md bg-surface-container-lowest p-10 rounded-2xl shadow-sm border border-outline-variant/30">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-headline font-extrabold text-on-surface">Create Account</h1>
          <p className="text-secondary text-sm mt-2">Join us for premium architectural collections</p>
        </div>
        ...
        {!isOtpSent ? (
          ...
          <form onSubmit={handleVerifyOtp} className="flex flex-col gap-6">
            ...
            <button 
              ...
              className="bg-gradient-to-br from-primary to-primary-container text-on-primary w-full mt-2 py-3 rounded-lg font-semibold tracking-wide hover:translate-y-[-2px] transition-transform active:scale-95 text-lg disabled:opacity-50 disabled:translate-y-0"
            >
...
export default function RegisterPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading architectural platform...</div>}>
      <RegisterContent />
    </Suspense>
  );
}
