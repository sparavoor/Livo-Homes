            ...
            {step === 2 && (
              ...
              >
                <div>
                  ...
                  <h2 className="font-headline text-3xl font-black text-primary tracking-tighter">Complete payment</h2>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="space-y-1">
                      <p className="font-headline font-black text-primary text-lg uppercase tracking-tight">Cash on Delivery</p>
                  ...
                  >
                    <div className="space-y-1">
                      <p className="font-headline font-black text-primary text-lg uppercase tracking-tight">Credit/Debit/ATM Card & UPI</p>
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  >
                    {isProcessing ? 'Synchronising Manifest...' : 'Complete Order'}
                  </button>
                  <button
                    onClick={() => setStep(1)}
